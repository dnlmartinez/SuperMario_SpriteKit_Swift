//
//  Mundo_1_Nivel_2.swift
//  SuperJoel
//
//  Created by daniel martinez gonzalez on 11/6/17.
...
class Mundo_1_Nivel_2: SKScene , SKPhysicsContactDelegate
{
    ...
    override func didMove(to view: SKView)
    {
        ...
        self.map = SKATiledMap.init(mapName: "SampleMapKenny_2")
    ...
    func Win(type: Int)
    {
        ...
        if type == 0
        {
            ...
            UserDefaults.standard.set(true , forKey: "nivel-2-completed")
