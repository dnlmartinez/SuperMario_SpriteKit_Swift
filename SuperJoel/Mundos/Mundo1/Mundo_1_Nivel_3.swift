//
//  Mundo_1_Nivel_3.swift
//  SuperJoel
//
//  Created by daniel martinez gonzalez on 20/6/17.
...
class Mundo_1_Nivel_3: SKScene , SKPhysicsContactDelegate
{
    ...
    override func didMove(to view: SKView)
    {
        ...
        self.joelM?.position = CGPoint(x: self.frame.minX + 90 , y: self.frame.maxY - 250)
        ...
        self.map = SKATiledMap.init(mapName: "SampleMapKenny_3")
    ...
    func playBackgroundMusic() -> ()
    {
        ...
        let backgroundMusicURL = NSURL(fileURLWithPath: Bundle.main.path(forResource: "mario-theme-1", ofType: "mp3")!)
        do
        {
    ...
    func Win(type: Int)
    {
        ...
        if type == 0
        {
            ...
            UserDefaults.standard.set(true , forKey: "nivel-3-completed")
